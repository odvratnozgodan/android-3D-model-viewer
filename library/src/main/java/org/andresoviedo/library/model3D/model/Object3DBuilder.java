package org.andresoviedo.library.model3D.model;

import android.net.Uri;
import android.opengl.GLES20;
import android.opengl.Matrix;
import android.util.Log;
import org.andresoviedo.library.model3D.services.collada.entities.Joint;
...
import org.andresoviedo.library.util.math.Math3DUtils;
...
public final class Object3DBuilder {
	...
	private org.andresoviedo.library.model3D.model.Object3D object3dv1;
	private org.andresoviedo.library.model3D.model.Object3D object3dv2;
	private org.andresoviedo.library.model3D.model.Object3D object3dv3;
	private org.andresoviedo.library.model3D.model.Object3D object3dv4;
	private org.andresoviedo.library.model3D.model.Object3D object3dv5;
	private org.andresoviedo.library.model3D.model.Object3D object3dv6;
	private org.andresoviedo.library.model3D.model.Object3D object3dv7;
	private org.andresoviedo.library.model3D.model.Object3D object3dv8;
	private org.andresoviedo.library.model3D.model.Object3D object3dv9;
    private org.andresoviedo.library.model3D.model.Object3D object3dv91;
	private org.andresoviedo.library.model3D.model.Object3D object3dv10;
	private org.andresoviedo.library.model3D.model.Object3D object3dv11;
    private org.andresoviedo.library.model3D.model.Object3D object3dv12;

	public static org.andresoviedo.library.model3D.model.Object3DData buildPoint(float[] point) {
		return new org.andresoviedo.library.model3D.model.Object3DData(createNativeByteBuffer(point.length * 4).asFloatBuffer().put(point))
				.setDrawMode(GLES20.GL_POINTS).setId("Point");
	}

	public static org.andresoviedo.library.model3D.model.Object3DData buildLine(float[] line) {
		return new org.andresoviedo.library.model3D.model.Object3DData(createNativeByteBuffer(line.length * 4).asFloatBuffer().put(line))
				.setDrawMode(GLES20.GL_LINES).setId("Line").setFaces(new Faces(0));
	}

	public static org.andresoviedo.library.model3D.model.Object3DData buildAxis() {
		return new org.andresoviedo.library.model3D.model.Object3DData(
	...
	public static org.andresoviedo.library.model3D.model.Object3DData buildCubeV1() {
		return new org.andresoviedo.library.model3D.model.Object3DData(
	...
	public static org.andresoviedo.library.model3D.model.Object3DData buildCubeV1_with_normals() {
		return new org.andresoviedo.library.model3D.model.Object3DData(
				createNativeByteBuffer(cubePositionData.length * 4).asFloatBuffer().put(cubePositionData))
	...
	public static org.andresoviedo.library.model3D.model.Object3DData buildSquareV2() {
		...
		return new org.andresoviedo.library.model3D.model.Object3DData(vertexBuffer,drawBuffer.asReadOnlyBuffer()).setDrawMode(GLES20.GL_TRIANGLES).setId("cubeV2")
				.centerAndScale(1.0f).setFaces(new Faces(8)).setDrawOrder(drawBuffer).setVertexArrayBuffer(vertexBuffer);
	}

	public static org.andresoviedo.library.model3D.model.Object3DData buildCubeV3(byte[] textureData) {
		return new org.andresoviedo.library.model3D.model.Object3DData(
				createNativeByteBuffer(cubePositionData.length * 4).asFloatBuffer().put(cubePositionData),
	...
	public static org.andresoviedo.library.model3D.model.Object3DData buildCubeV4(byte[] textureData) {
		return new org.andresoviedo.library.model3D.model.Object3DData(
				createNativeByteBuffer(cubePositionData.length * 4).asFloatBuffer().put(cubePositionData),
	...
	public static org.andresoviedo.library.model3D.model.Object3DData loadV5(IModelActivity activity, Uri modelUri) {
		try {
			...
			org.andresoviedo.library.model3D.model.Object3DData data3D = new org.andresoviedo.library.model3D.model.Object3DData(wfl.getVerts(), wfl.getNormals(), wfl.getTexCoords(), wfl.getFaces(),
	...
	public org.andresoviedo.library.model3D.model.Object3D getDrawer(org.andresoviedo.library.model3D.model.Object3DData obj, boolean usingTextures, boolean usingLights, boolean usingAnimation) throws IOException {

		if (object3dv2 == null) {
            try {
                getPointDrawer();
                object3dv2 = new org.andresoviedo.library.model3D.model.Object3DV2();
                object3dv3 = new org.andresoviedo.library.model3D.model.Object3DV3();
                object3dv4 = new org.andresoviedo.library.model3D.model.Object3DV4();
                object3dv5 = new org.andresoviedo.library.model3D.model.Object3DV5();
                object3dv6 = new org.andresoviedo.library.model3D.model.Object3DV6();
                object3dv7 = new org.andresoviedo.library.model3D.model.Object3DV7();
                object3dv8 = new org.andresoviedo.library.model3D.model.Object3DV8();
                object3dv9 = new org.andresoviedo.library.model3D.model.Object3DV9();
                object3dv91 = new org.andresoviedo.library.model3D.model.Object3DV91();
                object3dv10 = new org.andresoviedo.library.model3D.model.Object3DV10();
                object3dv11 = new org.andresoviedo.library.model3D.model.Object3DV11();
                object3dv12 = new org.andresoviedo.library.model3D.model.Object3DV12();
            } catch (Exception e) {
                Log.e("Object3DBuilder","Error creating drawer: "+e.getMessage(), e);
            }
        }

        boolean isAnimated = usingAnimation && obj instanceof org.andresoviedo.library.model3D.model.AnimatedModel && ((org.andresoviedo.library.model3D.model.AnimatedModel) obj).getAnimation() != null;
	...
	public static org.andresoviedo.library.model3D.model.Object3DData generateArrays(org.andresoviedo.library.model3D.model.Object3DData obj) throws IOException {
	...
	public org.andresoviedo.library.model3D.model.Object3D getBoundingBoxDrawer() {
		return object3dv2;
	}

	public org.andresoviedo.library.model3D.model.Object3D getFaceNormalsDrawer() {
		return object3dv1;
	}

	public org.andresoviedo.library.model3D.model.Object3D getPointDrawer() {
		if (object3dv1 == null) {
			object3dv1 = new org.andresoviedo.library.model3D.model.Object3DV1();
		}
		return object3dv1;
	}

	public static org.andresoviedo.library.model3D.model.Object3DData buildBoundingBox(org.andresoviedo.library.model3D.model.Object3DData obj) {
		BoundingBox boundingBox = new BoundingBox(obj.getBoundingBox(),
				obj.getColor());
		return new org.andresoviedo.library.model3D.model.Object3DData(boundingBox.getVertices()).setDrawModeList(boundingBox.getDrawModeList())
	 ...
	 */
	public static org.andresoviedo.library.model3D.model.Object3DData buildWireframe(org.andresoviedo.library.model3D.model.Object3DData objData) {
		...
		if (objData.getDrawOrder() != null) {
			...
			try {
				...
				if (objData instanceof org.andresoviedo.library.model3D.model.AnimatedModel){
					org.andresoviedo.library.model3D.model.AnimatedModel object3DData = new org.andresoviedo.library.model3D.model.AnimatedModel(objData.getVertexArrayBuffer());
					...
					object3DData.setVertexWeights(((org.andresoviedo.library.model3D.model.AnimatedModel) objData).getVertexWeights());
					object3DData.setJointIds(((org.andresoviedo.library.model3D.model.AnimatedModel) objData).getJointIds());
					object3DData.setRootJoint(((org.andresoviedo.library.model3D.model.AnimatedModel) objData).getRootJoint(), ((org.andresoviedo.library.model3D.model.AnimatedModel) objData)
							.getJointCount(), ((org.andresoviedo.library.model3D.model.AnimatedModel) objData).getBoneCount(), false);
					object3DData.doAnimation(((org.andresoviedo.library.model3D.model.AnimatedModel) objData).getAnimation());
					return object3DData;
				}
				else {
					return new org.andresoviedo.library.model3D.model.Object3DData(objData.getVertexArrayBuffer()).setVertexBuffer(objData.getVertexBuffer()).setDrawOrder(wireframeDrawOrder).
							setVertexNormalsArrayBuffer(objData.getVertexNormalsArrayBuffer()).setColor(objData.getColor())
							.setVertexColorsArrayBuffer(objData.getVertexColorsArrayBuffer()).setTextureCoordsArrayBuffer(objData.getTextureCoordsArrayBuffer())
							.setPosition(objData.getPosition()).setRotation(objData.getRotation()).setScale(objData.getScale())
							.setDrawMode(GLES20.GL_LINES).setDrawUsingArrays(false);
	 ...
	 * @return the 3d wireframe
	 */
	public static org.andresoviedo.library.model3D.model.Object3DData buildWireframe_from_original(org.andresoviedo.library.model3D.model.Object3DData objData) {
		try {
			...
			return new org.andresoviedo.library.model3D.model.Object3DData(objData.getVertexBuffer()).setDrawOrder(drawOrder).
	 ...
	 */
	public static org.andresoviedo.library.model3D.model.Object3DData buildFaceNormals(org.andresoviedo.library.model3D.model.Object3DData obj) {
		...
		return new org.andresoviedo.library.model3D.model.Object3DData(normalsLines).setDrawMode(GLES20.GL_LINES).setColor(obj.getColor())
				.setPosition(obj.getPosition()).setVersion(1);
	}

	public static org.andresoviedo.library.model3D.model.AnimatedModel buildSkeleton(org.andresoviedo.library.model3D.model.AnimatedModel animatedModel){
        float[] identity = new float[16];
        Matrix.setIdentityM(identity,0);

        org.andresoviedo.library.model3D.model.AnimatedModel skeleton = new org.andresoviedo.library.model3D.model.AnimatedModel(createNativeByteBuffer(animatedModel.getJointCount()*3*3*4)
                .asFloatBuffer());
    ...
    private static void buildBones(org.andresoviedo.library.model3D.model.AnimatedModel animatedModel, Joint joint, float[] parentTransform, float[]
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(org.andresoviedo.library.model3D.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(org.andresoviedo.library.model3D.entities.BoundingBox box) {
		//@formatter:off
