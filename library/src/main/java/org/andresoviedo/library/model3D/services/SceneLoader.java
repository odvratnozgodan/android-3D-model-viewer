package org.andresoviedo.library.model3D.services;
...
import org.andresoviedo.library.model3D.animation.Animator;
import org.andresoviedo.library.model3D.collision.CollisionDetection;
import org.andresoviedo.library.model3D.entities.Camera;
import org.andresoviedo.library.model3D.model.Object3DBuilder;
import org.andresoviedo.library.model3D.model.Object3DData;
import org.andresoviedo.library.model3D.services.collada.ColladaLoaderTask;
import org.andresoviedo.library.model3D.services.stl.STLLoaderTask;
import org.andresoviedo.library.model3D.services.wavefront.WavefrontLoaderTask;
...
public class SceneLoader implements LoaderTask.Callback {
     ...
     * Parent component
     */
    protected final IModelActivity parent;
    /**
    ...
    public SceneLoader(IModelActivity main) {
        this.parent = main;
    }
